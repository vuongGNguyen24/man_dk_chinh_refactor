...
class FireControlModule:
    def __init__(self, infra: InfrastructureContainer, main_window: FireControlUI, log_adapter: Optional[LogTabAdapter]=None):
        self.infra = infra
    ...
    def build(self):
        ...
        self.fire_service = FiringControlService(input_port=self.launcher_input_adapter, 
