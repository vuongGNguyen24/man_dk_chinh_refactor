...
class MainCircultTab(GridBackgroundWidget):
    """
    ...
    def __init__(self,  node_adapter: Union[QtSystemStatusAdapter, None] = None, parent=None):
        ...
        self.diagram = SystemDiagramView(
            ui_file="ui/views/system_diagram/layout/ban_dieu_khien_tu_xa.ui",
            fps=30,
            node_adapter=node_adapter,
            json_connections_path="ui/views/system_diagram/layout/ban_dk_connection_mapping.json",
...
if __name__ == "__main__":
    ...
    tab = MainCircultTab(parent=None)
